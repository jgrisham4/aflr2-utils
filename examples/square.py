...
sq_mesh = m.Mesh([outer_edge])

# Writing bedge file
sq_mesh.write_bedge("{}.bedge".format(root_name))

# Calling aflr2
aflr2_command = "simcenter aflr2 -ibedge -ascii {}".format(root_name)
